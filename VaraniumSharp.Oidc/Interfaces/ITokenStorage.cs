...
namespace VaraniumSharp.Oidc.Interfaces
{
    ...
    /// <remark>
    /// Tokens should be stored securely, a leaked token will grant access to user account as if it is the user. Suggested to use account based encryption for storing on local machine
    /// </remark>
    /// </summary>
